...
<h3><center>Search Patient Data</center></h3>
<form action="SeePat.jsp" method="post" align="center">
...
<table align="center">
	...
	<button type="button" name="back" value="Back" href="SeePat.jsp" style="border-radius: 12px;background-color: #4CAF50;border: none;color: white;padding: 15px;
  text-align: center;
  text-decoration: none;
  display: inline-block;
  font-size: 16px;
  margin: 4px 2px;
  cursor: pointer;" onclick="document.location='SeePat.jsp'"><i class="fa fa-chevron-circle-left"></i> Back</button>
</form>
</body>
</html>