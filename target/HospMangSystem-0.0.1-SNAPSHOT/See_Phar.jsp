<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <%@ page import="javax.servlet.http.HttpSession,javax.servlet.http.HttpServletRequest,hms.bean.Patient,hms.bean.Pharmacy,java.util.List" %>
<!DOCTYPE html>
<html>
<head>
...
<form action="Phar.jsp" method="post" align="center">
...
<% } %>
    ...
    <button type="button" name="issue_medicine" value="issue_medicine" style="border-radius: 12px;background-color: #4CAF50;border: none;color: white;padding: 15px;
  text-align: center;
  text-decoration: none;
  display: inline-block;
  font-size: 16px;
  margin: 4px 2px;
  cursor: pointer;" onclick="document.location='issue_medicine.jsp'">Issue Medicines <i class="fa fa-plus-circle"></i></button>
