...
<ul>
  ...
  <li class="dropdown"><a href="#" class="dropbtn">Bill_Payment</a>
  <div class="dropdown-content">
...
<center><h3>Delete Patient Data</h3></center>
<div align="center">
...
<button type="submit" name="action" value="trash" style="border-radius: 12px;background-color: #4CAF50;border: none;color: white;padding: 15px;
  text-align: center;
  text-decoration: none;
  display: inline-block;
  font-size: 16px;
